...
class _MainScreenState extends State<MainScreen> {
  ...
  void onSearch() async{
    ...
    setState(() {
      isLoading = false;
      chats.add(ChatTile(userMap['Name'], false, userMap['uid'], FirebaseAuth.instance.currentUser!.uid, chatId(FirebaseAuth.instance.currentUser!.uid, userMap['uid'], ), _controller));
      isEmpty = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     ),
      //     MaterialButton(onPressed: onSearch, child: isLoading?CircularProgressIndicator(color: Colors.white,):Text("Search", style: TextStyle(color: Colors.white),),color: Colors.lightBlueAccent,),
      //     Expanded(
      //       child: isEmpty==false?ListView(
      //         children: chats,
      //       ):Container(),
      //     ),
      //   ],
